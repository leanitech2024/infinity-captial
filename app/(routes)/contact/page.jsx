...
export default function ComingSoon() {
  ...
  return (
    <>
      <section
        className="coming-soon bg_op_1"
        style={{ background: 'url(/assets/images/coming-soon-bg.jpg)' }}
      >
        {/*===============spacing==============*/}
              ...
              <div className="upper_section">
                ...
                <div className="title">
                  ...
                  <p>
                    ...
                    we will give you a complete account of system.
                  </p>
                </div>
              </div>
              <div className="Countdown-timer">
                <div
                  className="countdown text-left"
                  data-date="Feb 15 2024 23:59:59"
                >
                  <Countdown
