                  ...
                  <div className="service_box style_three dark_color">
                    <div className="service_content">
                      <div className="content_inner">
                        ...
                        <p>
                          Right to find fault with a mans who chooses enjoy has
                          no annoying.
                        </p>
                        <Link href="#" className="read_more">
                          Read more <i className="icon-right-arrow" />
              ...
              <div className="row">
                  ...
                  <div className="title_all_box style_one  dark_color">
                    <div className="title_sections left">
                      ...
                      <p>
                        ...
                        are beguiled and demoralized by the charms of pleasure.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                  <div className="progress_bar style_three">
                    <h2>
                      Recruitment Process <span>48%</span>
                    </h2>
                    <div className="bar">
                      <div
                  ...
                  <div className="progress_bar style_three">
                    <h2>
                      Employee Relations <span>79%</span>
                    </h2>
                    <div className="bar">
                      <div
                        className="bar-inner count-bar counted"
                  ...
                  <div className="progress_bar style_three">
                    <h2>
                      Compliance Audits <span>65%</span>
                    </h2>
                    <div className="bar">
                      <div
                        className="bar-inner count-bar counted"
                      ...
                      <ul className="showcase_tabs_btns nav-pills nav clearfix">
                        ...
                        <li className="nav-item">
                          <a
                            ...
                            onClick={() => handleOnClick2(3)}
                            data-tab="#tabtabtwothree"
                          >
                            03. HR Audit
                          </a>
                        </li>
                          ...
                          <div className="tab_content one">
                            <div className="row">
                              <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-5 mb-lg-0 mb-xl-0">
                                <div className="image">
                                  <img
                                    src="/assets/images/tab-ser-img.png"
                                    alt="img"
                                  />
                                </div>
                              </div>
                            ...
                            <div className="row">
                              ...
                              <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div className="content_bx">
                                  ...
                                  <p>
                                    Must explain too you how all this mistaken
                                    idea of denouncing pleasures praising pain
                                    was born and we will give you complete
                                    account of the system the actual teachings
