          ...
          <div className="auto-container">
            <div className="row default_row">
              ...
              >
                <main
                  id="main"
                  className="site-main products_single"
                  role="main"
                >
                          ...
                          <div className="summary entry-summary">
                            ...
                            <div className="woocommerce-product-details__short-description">
                              <p>
                                ...
                                pleasure of the moment blinded by desire that
                                they cannot foresee the pain and trouble that
                                are bound to and equal blame belongs to those
                                who fail in their duty.
                              </p>
                              <p>
                                Nor again is there anyone who loves or pursues
                                or desires to pain of because it is pain, but
                              ...
                              <p>
                                ...
                                of denouncing pleasure praising will give you a
                                completed great the great explorer.
                              </p>
                            </div>
                            ...
                            <div className="d-flex align-items-center">
                              <div
                                className="yith-wcwl-add-to-wishlist add-to-wishlist-2650  wishlist-fragment on-first-load"
                            ...
                            <div className="product_meta">
                              <span className="posted_in">
                                Categories:{' '}
                                <Link href="shop-details" rel="tag">
                                  Coaching
                                </Link>
                                ,
                                <Link href="#" rel="tag">
                                  ...
                                  <div id="review_form_wrapper">
                                    <div id="review_form">
                                      ...
                                      >
                                        ...
                                        >
                                          Be the first to review “Esssays Change
                                          You Think”{' '}
                                          <small>
                                            <Link
                                              id="cancel-comment-reply-link"
                                              href="/wp/creote/v-new/product/esssays-change-you-think/#respond"
                                              style={{ display: 'none' }}
                                            >
                                              Cancel reply
                                            </Link>
                                        ...
                                        <form
                                          action="https://themepanthers.com/wp/creote/v-new/wp-comments-post.php"
                                          method="post"
                                          id="commentform"
                              ...
                              >
                                <div className="content_box">
                                  ...
                                  <p>
                                    ...
                                    pursues or desires to pain of because it is
                                  ...
                                  <p>
                                    ...
                                    idea of denouncing pleasure praising will
                                    give you a completed great the great
                                    explorer.
                                  </p>
                                </div>
                              </div>
                    ...
                    <div className="auto-container">
                      <div className="row gutter_30px">
                        <div className="col-lg-12">
                          ...
                          <Swiper
                            {...swiperOptions}
                            className="product_related_posts theme_carousel"
                          >
                              ...
                              <div className="product_box type_one">
                                <div className="inner_box">
                                  <div className="image_box">
                                    <img
                                      src="/assets/images/products/product-1-min.png"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </div>
                                  <div className="overlay">
                                    <ul>
                                      <li className="upper_box">
                                        <Link
                                          href="#"
                                          className="creote_quick_view_btn"
                                        >
                            ...
                            <SwiperSlide className="project-wrapper grid-item">
                              <div className="product_box type_one">
                                <div className="inner_box">
                                  <div className="image_box">
                                    <img
                                      src="/assets/images/products/product-5-min.png"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </div>
                            ...
                            <SwiperSlide className="project-wrapper grid-item product type-product status-publish last instock product_cat-coaching product_cat-employee-relation product_cat-recruiting has-post-thumbnail virtual sold-individually purchasable product-type-simple">
                              <div className="product_box type_one">
                                <div className="inner_box">
                                  <div className="image_box">
                                    <img
                                      src="/assets/images/products/product-9-min.png"
                                      className="img-fluid"
                                      alt="img"
                                    />
                                  </div>
                                ...
                                <div className="content_box">
                                  ...
                                  <h2>
                                    <Link href="shop-details">
                                      Start Living The Adventures of Yes
                                    </Link>
                                  </h2>
                                  <div className="product_attributes"></div>
                                  <div className="rating_price">
                ...
                <div className="page_siderbar side_bar fixSide_scroll">
                  ...
                  <div className="widgets_grid_box">
                    <div
                      ...
                      className="widget woocommerce widget_top_rated_products"
                    >
                      ...
                      <ul className="product_list_widget">
                        <li>
                          <Link href="shop">
                            <img
                              src="/assets/images/products/product-10-min.png"
                              className="img-fluid"
                              alt="img"
                            />
                          </Link>
                        ...
                        <li>
                          <Link href="shop">
                            <img
                              src="/assets/images/products/product-8-min.png"
                              className="img-fluid"
                              alt="img"
                            />
                          </Link>
                        ...
                        <li>
                          <Link href="shop">
                            <img
                              src="/assets/images/products/product-7-min.png"
                              className="img-fluid"
                            />
                          </Link>
                          <div className="content">
                        ...
                        <li>
                          <Link href="shop">
                            <img
                              src="/assets/images/products/product-6-min.png"
                              className="img-fluid"
                              alt="img"
                            />
                          </Link>
