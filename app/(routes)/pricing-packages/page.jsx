          ...
          <section className="call-to-action mr_bottom_minus_140 position-relative z_99">
            <div className="container">
              <div className="call_to_action style_two">
                <div className="image">
                  <img
                    src="/assets/images/call-to-pric-bg-1.jpg"
                    className="img-fluid"
                    alt="image"
                  />
                </div>
                          ...
                          <div className="bottom_content">
                            <div className="call_content">
                              ...
                              <div className="content_bx">
                                ...
                                <p>
                                  {' '}
                                  Email: sendmail@qetus.com &amp; Phone: +98 060
                                  712 34{' '}
                                </p>
                              </div>
                            </div>
                  ...
                  <div className="service_box style_four dark_color">
                    <div className="service_content">
                      ...
                      <div className="content_inner">
                        <h2>
                          <Link href="#">Chat With a Live</Link>
                        </h2>
                        <p>Live Chat</p>
                      </div>
                    </div>
                ...
                <div className="col-lg-4">
                  <div className="service_box style_four dark_color">
                    <div className="service_content">
                      ...
                      <div className="content_inner">
                        <h2>
                          <Link href="#">Ask Professionals</Link>
                        </h2>
                        <p>our Team</p>
                      </div>
                    </div>
                ...
                <div className="col-lg-4">
                  <div className="service_box style_four dark_color">
                    <div className="service_content">
                      ...
                      <div className="content_inner">
                        <h2>
                          <Link href="#">Support to Grow</Link>
                        </h2>
                        <p>User Guides</p>
                      </div>
                    </div>
