            ...
            <div className="row default_row">
              ...
              >
                ...
                <main id="main" className="site-main" role="main">
                  <section className="project_all filt_style_three ">
                    <div
                      className="project_container clearfix"
                      style={{ position: 'relative', height: 3246 }}
                    >
                      <div className="row clearfix">
                        <div
                          className="project-wrapper grid-item   col-lg-12 col-md-12 col-sm-12 col-xs-12  project_category-coaching"
                          style={{ position: 'absolute', left: 0, top: 0 }}
                        >
                          <div className="project_post style_one">
                            <div className="image">
                              <img
                                loading="lazy"
                                width={746}
                        ...
                        <div
                          className="project-wrapper grid-item   col-lg-12 col-md-12 col-sm-12 col-xs-12  project_category-human-resources"
                          style={{ position: 'absolute', left: 0, top: 541 }}
                        >
                          <div className="project_post style_one">
                            <div className="image">
                              <img
                        ...
                        <div
                          className="project-wrapper grid-item col-lg-12 col-md-12 col-sm-12 col-xs-12 project_category-leadership"
                          style={{ position: 'absolute', left: 0, top: 1082 }}
                        >
                          <div className="project_post style_one">
                            <div className="image">
                              <img
                        ...
                        <div
                          className="project-wrapper grid-item   col-lg-12 col-md-12 col-sm-12 col-xs-12  project_category-pre-sale"
                          style={{ position: 'absolute', left: 0, top: 1623 }}
                        >
                          <div className="project_post style_one">
                            <div className="image">
                              <img
                            ...
                            <div className="project_caro_content">
                              <div className="left_side">
                                ...
                                <h2 className="title_pro">
                                  <Link href="project-details">
                                    Time HR Prepares Plastic Contract
                                    Manufacturer
                                  </Link>
                                </h2>
                              </div>
                        ...
                        <div
                          className="project-wrapper grid-item   col-lg-12 col-md-12 col-sm-12 col-xs-12  project_category-recruiting"
                          style={{ position: 'absolute', left: 0, top: 2164 }}
                        >
                          <div className="project_post style_one">
                            <div className="image">
                              <img
                        ...
                        <div
                          className="project-wrapper grid-item   col-lg-12 col-md-12 col-sm-12 col-xs-12  project_category-values"
                          style={{ position: 'absolute', left: 0, top: 2705 }}
                        >
                          <div className="project_post style_one">
                            <div className="image">
                              <img
                            ...
                            <div className="project_caro_content">
                              <div className="left_side">
                                ...
                                <h2 className="title_pro">
                                  <Link href="project-details">
                                    Six Essential Steps To Writing Successful
                                    Job
                                  </Link>
                                </h2>
                              </div>
                ...
                <div className="side_bar">
                  ...
                  <div className="widgets_grid_box">
                    <form
                      ...
                      method="get"
                      action="/"
                      className="wp-block-search__no-button wp-block-search"
                    >
                      <label
                  ...
                  <div className="widgets_grid_box">
                    <div className="widget widget_about_authour">
                      <div className="about_authour widget_box">
                  ...
                  <div className="widgets_grid_box">
                    <div className="widget widget_block">
                      ...
                      <ul className="wp-block-categories-list wp-block-categories">
                        <li>
                          <Link href="#">Beds</Link> (1)
                        </li>
                        <li>
                          <Link href="#">Coaching</Link> (5)
                        </li>
                        <li>
                          <Link href="#">Compliance Audits</Link> (5)
                        </li>
                        <li>
                          <Link href="#">Employee Relations</Link> (8)
                        </li>
                        <li>
                          <Link href="#">Furnitures</Link> (1)
                        </li>
                        <li>
                          <Link href="#">HR Consulting</Link> (7)
                        </li>
                        <li>
                          <Link href="#">Lights</Link> (1)
                        </li>
                        <li>
                          <Link href="#">Recruiting</Link> (6)
                        </li>
                        <li>
                          <Link href="#">Small Business HR</Link> (7)
                        </li>
                        <li>
                          <Link href="#">Tables</Link> (1)
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div className="widgets_grid_box">
                    <div className="widget creote_widget_recented_entries">
                      <h2 className="widgettitle">Recent Posts</h2>
                      <div className="post_inner cr_wid_post inner_box ">
                        <div className="blog_in clearfix image_in">
                          ...
                          <div className="content_inner">
                            <p className="post-date">
                              ...
                              October 8, {new Date().getFullYear()}
                            </p>
                            <h3>
                              <Link href="/">
                        ...
                        <div className="blog_in clearfix image_in">
                          ...
                          <div className="content_inner">
                            ...
                            <h3>
                              <Link href="/">How to Handle Employee</Link>
                            </h3>
                          </div>
                        </div>
                        <div className="blog_in clearfix image_in">
