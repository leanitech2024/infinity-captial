              ...
              <main id="main" className="site-main" role="main">
                ...
                <section className="blog_single_details_outer">
                      ...
                      <div className="row gutter_30px">
                        <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-5 mb-lg-5 mb-xl-0">
                          <div className="simple_image_boxes">
                            <img
                              ...
                              className="simp_img img-fluid height_540px"
                              alt="image"
                            />
                          </div>
                          {/*===============spacing==============*/}
                        ...
                        <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div className="simple_image_boxes">
                            <img
                              src="/assets/images/blog/blog-image-9.jpg"
                              className="simp_img img-fluid height_260"
                              alt="image"
                            />
                          </div>
                          {/*===============spacing==============*/}
                          ...
                          <div className="simple_image_boxes ">
                            <img
                              src="/assets/images/blog/single-post-gal-2.jpg"
                              className="simp_img img-fluid height_250px"
                              alt="image"
                            />
                          </div>
                        </div>
                  ...
                  <div className="single_content_lower">
                    ...
                    <div
                      className="sec_comments padding-t-8 padding-b-3"
                      id="comment"
                    >
                            ...
                            <div id="respond" className="comment-respond">
                              ...
                              >
                                ...
                                <p className="custom-control custom-checkbox">
                                  ...
                                  />
                                  <label
                                    className="custom-control-label pl-1 c-gray"
                  ...
                  <div className="widget_post_box">
                    ...
                    <div className="blog_in clearfix image_in">
                      ...
                      <div className="content_inner">
                        ...
                        <h3>
                          <Link href="/">Most Employees Support Measures</Link>
                        </h3>
                      </div>
                    </div>
                    <div className="blog_in clearfix image_in">
