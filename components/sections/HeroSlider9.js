          ...
          <SwiperSlide className="slide-item-content">
            <div className="slide-item content_center">
              <div
                ...
                style={{
                  backgroundImage:
                    'url(/assets/images/sliders/slider-11-1.jpg)',
                }}
              ></div>
                  ...
                  <div className="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div className="slider_content">
                      ...
                      <h1 className="animate_left">
                        {' '}
                        Focus on your Business, Reduce Cost andLimit Liability,
                        with HR Solutions{' '}
                      </h1>
          ...
          <SwiperSlide className="slide-item-content">
            <div className="slide-item content_center">
              <div
                ...
                style={{
                  backgroundImage:
                    'url(/assets/images/sliders/slider-11-2.jpg)',
                }}
              ></div>
              <div className="auto-container">
                <div className="row align-items-center">
                  <div className="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div className="slider_content">
                      ...
                      <h1 className="animate_right">
                        We offer health care benefits , planning, benefit
