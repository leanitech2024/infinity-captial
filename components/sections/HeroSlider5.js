          ...
          <SwiperSlide className="slide-item">
            <div className="slide-item-content content_center">
              <div
                ...
                style={{
                  backgroundImage: 'url(/assets/images/sliders/slider-5-3.jpg)',
                }}
              ></div>
                  ...
                  <div className="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div className="slider_content">
                      <h1 className="animated _fadeInDownBig">
                        ...
                        <span>
                          {' '}
                          Platform that Scales Your Growth<span></span>
                        </span>
                      </h1>
                      ...
                      <div className="thm_btn animated _zoomIn">
                        ...
                        <Link
                          href="#"
                          className="theme-btn two  animated _zoomIn"
                        >
                          Contact Us{' '}
                        </Link>
                      </div>
          ...
          <SwiperSlide className="slide-item">
            <div className="slide-item-content content_center">
              <div
                className="image-layer"
                style={{
                  backgroundImage: 'url(/assets/images/sliders/slider-5-1.jpg)',
                }}
              />
              <div className="auto-container">
                <div className="row">
          ...
          <SwiperSlide className="slide-item">
            <div className="slide-item-content content_left">
              <div
                className="image-layer"
                style={{
                  backgroundImage: 'url(/assets/images/sliders/slider-5-2.jpg)',
                }}
              ></div>
              <div className="auto-container">
                <div className="row">
