            ...
            <div className="col-lg-12">
              <div className="section__counter four_column">
                <div
                  ...
                  style={{ position: 'relative', height: '231.219px' }}
                >
                  ...
                  <div
                    className="grid_box _card"
                    style={{ position: 'absolute', left: '75%', top: 0 }}
                  >
                    <div className="counter-block style_one count-box counted">
                      <div className="icon_box  ">
                        <div className="icon">
                          <img
                            src="/assets/images/fun-4.png"
                            className="img-fluid svg_image"
                            alt="icon png"
                          />
                        </div>
