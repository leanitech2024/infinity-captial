...
export default function Service13() {
  return (
    <>
      <section
        className="service-section bg_op_3"
        style={{ background: 'url(/assets/images/home-12-service-bg.jpg)' }}
      >
        {/*===============spacing==============*/}
              ...
              <div className="title_all_box style_one text-center light_color">
                <div className="title_sections">
                  ...
                  <p>
                    ...
                    implement recruitment programs, and <br /> initiate employee
                    ...
                    <div className="text_box">
                      <div className="text_box_inner">
                        ...
                        <h2 className="title_service">
                          <Link href="/index/service/talent-management/">
                            Talent Management
                          </Link>
                        </h2>
                        <p className="short_desc">
                          Once your company has hired the best employees, the
                          next step.
                        </p>
                        <Link
                          className="read_more"
                          href="/index/service/talent-management/"
                        >
                          {' '}
                          Read More
                  ...
                  <div className="service_post style_three">
                    ...
                    <div className="text_box">
                      <div className="text_box_inner">
                        <span className="icon icon-thumbs-up icon" />
                        <h2 className="title_service">
                          <Link href="/index/service/health-care-benefits/">
                        ...
                        <Link
                          className="read_more"
                          href="/index/service/health-care-benefits/"
                        >
                          {' '}
                          Read More
                          <i className="icon-right-arrow-long" />
                  ...
                  <div className="service_post style_three">
                    ...
                    <div className="text_box">
                      <div className="text_box_inner">
                        <span className="icon icon-thumbs-up icon" />
                        <h2 className="title_service">
                          <Link href="/index/service/risk-management/">
                            Risk Management
                          </Link>
                        </h2>
                        <p className="short_desc">
                        ...
                        <Link
                          className="read_more"
                          href="/index/service/risk-management/"
                        >
                          {' '}
                          Read More
                          <i className="icon-right-arrow-long" />
