          ...
          <SwiperSlide className="slide-item">
            <div className="slide-item-content content_left">
              <div
                ...
                style={{
                  backgroundImage: 'url(/assets/images/sliders/slider-6-2.jpg)',
                }}
              ></div>
          ...
          <SwiperSlide className="slide-item">
            <div className="slide-item-content content_left">
              <div
                className="image-layer"
                style={{
                  backgroundImage: 'url(/assets/images/sliders/slider-6-3.jpg)',
                }}
              />
              <div className="auto-container">
                <div className="row">
          ...
          <SwiperSlide className="slide-item">
            <div className="slide-item-content content_left">
              <div
                className="image-layer"
                style={{
                  backgroundImage: 'url(/assets/images/sliders/slider-6-1.jpg)',
                }}
              ></div>
              <div className="auto-container">
                <div className="row">
