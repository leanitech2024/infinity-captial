...
export default function About12() {
  ...
  return (
    <>
      <section className="about-section bg_light_1 position-relative">
        {/*===============spacing==============*/}
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="title_all_box style_seven  dark_color">
                <div className="title_sections">
                  ...
                  <div className="title">Welcome to the Consultive</div>
                  <div className="small_text_sub">About Us</div>
                  <p className="description_text">
                    Mentor has extensive experience across all industries. We
                    help our clients set new standards of excellence...
                  </p>
                  <p className="description_text">
                    Over 20 years of experience we’ll ensure you always get the
                    best guidance. We serve a clients at every level of their
                    organization we can be most useful, whether as a trusted
                    advisor to top trusted our management coach for fronts line
                    employees.
                  </p>
                </div>
              </div>
              ...
              {/*===============spacing==============*/}
              <div className="icon_carousel_box_all">
                <Swiper
                  {...swiperOptions}
                  className="owl_dots_block theme_carousel"
                >
                  <SwiperSlide className="icon_caro type_one">
                    <div className="icon">
                      <img
                        src="/assets/images/shooting-target.png"
                    ...
                    <div className="text">
                      <h2>
                        <Link href="#">Our Mision</Link>
                      </h2>
                      <p>
                        There anyone who loves pursues desires to obtain pain
                        itself, because it is pain, but because occasionally uts
                        circumstances which toil and pain can procure.
                      </p>
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="image_box_new type_two clearfix pd_left_40 md_pd_left_zero">
