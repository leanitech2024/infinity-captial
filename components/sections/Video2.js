    ...
    <>
      <section className="video-section">
        <div className="container-fluid pd_zero">
          <div className="row">
            <div
              className="col-lg-6 col-md-6 col-sm-12 col-xs-12 overflow-hidden pd_zero bg_op_1 rounded_top_right_30 rounded_bottom_right_30"
              style={{ background: 'url(/assets/images/about/about-2.jpg)' }}
            >
              {/*===============spacing==============*/}
              ...
              <div className="row align-items-center gutter_25px">
                ...
                <div className="col-lg-5 col-md-12">
                  <img
                    ...
                    className="img-fluid object-fit-cover-center height_200px rounded_radius"
                    alt="img"
                  />
                </div>
              </div>
