...
export default function Service15() {
  const swiperOptions = {
    modules: [Autoplay],
    slidesPerView: 3,
    spaceBetween: 30,
  ...
  return (
    <>
      <section className="service-section bg_dark_1 position-relative">
        {/*===============spacing==============*/}
            ...
            <div className="col-lg-8 m-auto">
              <div className="title_all_box style_seven text-center light_color">
                <div className="title_sections">
                  ...
                  <div className="title"> We Offer Different Services</div>
                  <div className="small_text_sub">Our Services</div>
                </div>
                {/*===============spacing==============*/}
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="service_all_styles carousel owl_new_one">
                <Swiper
                  {...swiperOptions}
                  className="owl_nav_block owl_dots_none owl_type_one theme_carousel"
                >
                  <SwiperSlide className="service_box type_two light_color clearfix">
