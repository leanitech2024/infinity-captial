...
export default function HeroSlider11() {
  const swiperOptions = {
    // General
      ...
      <section className="slider style_page_thirteen nav_position_one position-relative">
        ...
        >
          <SwiperSlide className="slide-item-content">
            <div className="slide-item content_center">
              <div
                ...
                style={{
                  backgroundImage:
                    'url(/assets/images/sliders/slider-home-13-1.jpg)',
                }}
              ></div>
                ...
                <div className="row align-items-center">
                  <div className="col-lg-8 col-md-12 col-sm-12 col-xs-12 m-auto">
                    <div className="slider_content">
                      <h6 className="animate_left">Strategy &amp; Planning</h6>
                      <h1 className="animate_up">
                        The Fastest Way to Achieve Success
                      </h1>
                      <p className="animate_right pd_bottom_40">
                        Who are so beguiled and demoralized the charms Long
                        established fact <br /> that a reader will be distracted
                      </p>
                      <ul className="animate_down">
                        ...
                        <li className="theme_btn_all ">
                          <Link href="#" className="theme-btn one color_white">
                            Projects
                          </Link>
                        </li>
                      </ul>
          ...
          <SwiperSlide className="slide-item-content">
            <div className="slide-item content_left">
              <div
                ...
                style={{
                  backgroundImage:
                    'url(/assets/images/sliders/slider-home-13-2.jpg)',
                }}
              ></div>
              <div className="medium-container">
                <div className="row align-items-center">
          ...
          <div className="owl-nav">
            <div className="owl-prev h11p">
              <span>‹</span>
            </div>
            <div className="owl-next h11n">
              <span>›</span>
            </div>
          </div>
        </Swiper>
