                ...
                <div className="block_faq">
                  <div className="accordion">
                    <dl>
                      <dt
                        className={
                          isActive.key == 1 ? 'faq_header active' : 'faq_header'
                        }
                        onClick={() => handleToggle(1)}
                      >
                        <span className="icon-play" /> What sectors or
                        industries do you recruit for?
                      </dt>
                      <dd
                      ...
                      <dt
                        className={
                          isActive.key == 2 ? 'faq_header active' : 'faq_header'
                        }
                        onClick={() => handleToggle(2)}
                      >
                        <span className="icon-play" /> What recruitment services
                        do you offer?
                      </dt>
                      <dd
                        className="accordion-content hide"
                      ...
                      <dt
                        className={
                          isActive.key == 3 ? 'faq_header active' : 'faq_header'
                        }
                        onClick={() => handleToggle(3)}
                      >
                        <span className="icon-play" /> Where will you advertise
                        my job vacancy?
                      </dt>
                      <dd
                        className="accordion-content hide"
                      ...
                      <dt
                        className={
                          isActive.key == 4 ? 'faq_header active' : 'faq_header'
                        }
                      ...
                      <dt
                        className={
                          isActive.key == 5 ? 'faq_header active' : 'faq_header'
                        }
