                    ...
                    <div className="service_carousel style_one">
                      <div className="image">
                        ...
                        <img
                          ...
                          className="attachment-creote-service-image size-creote-service-image"
                          alt="img"
                        />
                      </div>
                      <div className="content">
                        ...
                        <h2 className="title_service">
                          <Link href="/service">Health Care Benefits</Link>
                        </h2>
                      </div>
                    </div>
                  </SwiperSlide>
                  <SwiperSlide>
                    <div className="service_carousel style_one">
                      ...
                      <div className="content">
                        ...
                        <h2 className="title_service">
                          <Link href="/service">Risk Management</Link>
                        </h2>
                      </div>
                    </div>
                  </SwiperSlide>
                  <SwiperSlide>
                    <div className="service_carousel style_one">
                      ...
                      <div className="content">
                        ...
                        <h2 className="title_service">
                          <Link href="/service">Compliance Audits</Link>
                        </h2>
                      </div>
                    </div>
                  </SwiperSlide>
                  <SwiperSlide>
                    <div className="service_carousel style_one">
                      ...
                      <div className="content">
                        ...
                        <h2 className="title_service">
                          <Link href="/service">Employee Relations</Link>
                        </h2>
                      </div>
                    </div>
                  </SwiperSlide>
                  <SwiperSlide>
                    <div className="service_carousel style_one">
                      ...
                      <div className="content">
                        ...
                        <h2 className="title_service">
                          <Link href="/service">Talent Management</Link>
                        </h2>
                      </div>
                    </div>
                  </SwiperSlide>
