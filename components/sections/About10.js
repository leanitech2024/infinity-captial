            ...
            <div className="col-lg-10 m-auto">
              <div className="title_all_box style_one text-center dark_color">
                <div className="title_sections">
                  ...
                  <div className="title">
                    Recruitment First HR Solutions can help.
                  </div>
                </div>
                {/*===============spacing==============*/}
            ...
            <div className="col-xl-6 col-lg-6 col-md-12 pd_left_60 md_pd_left_15">
              <div className="title_all_box style_one  dark_color">
                <div className="title_sections left">
                  <h5 className="title font_20">
                    We take the time to develop a strong working relationship
                    with you by understanding your needs, your business and your
                    corporate culture.
                  </h5>
                </div>
              </div>
              ...
              <div className="description_box">
                <p>
                  Countsy provides Finance, Accounting and HR Solutions to
                  venture backed startups. Through a unique combination of an on
                  demand CFO, CPO (Chief People Officer) and technologies.
                </p>
              </div>
              {/*===============spacing==============*/}
              ...
              <div className="description_box">
                <p>
                  We also have a number of staff who are recipients and who are
                  currently working advanced HR degrees. We are very proud of
                  our long and successful history of organizations industries .
                </p>
              </div>
              {/*===============spacing==============*/}
