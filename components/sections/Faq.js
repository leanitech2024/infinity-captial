...
export default function Faq() {
  ...
  return (
    <>
      <section
        className="faq-section bg_op_1 position-relative"
      ...
      >
        ...
        <div className="container-fluid pd_zero">
          <div className="row">
                ...
                <dl className="accordion faqs_accordion type_one light_color">
                  ...
                  >
                    <div className="title_box">
                      <span className="faq_no">1 </span> How can use content
                      marketing to increase efficient way?
                    </div>
                  </dt>
                  <dd
                  ...
                  >
                    <div className="title_box">
                      <span className="faq_no">2 </span> How can content
                      marketing help purchase journey?
                    </div>
                  </dt>
                  <dd
                    className="accordion-content"
                  ...
                  >
                    <div className="title_box">
                      <span className="faq_no">3 </span> How do we measure
                      content’s on sales and revenue?
                    </div>
                  </dt>
                  <dd
                    className="accordion-content"
                  ...
                  >
                    <div className="title_box">
                      <span className="faq_no">4 </span> Pain these cases are
            ...
            <div
              className="col-lg-6 col-sm-12 col-xs-12 position-relative z_99"
              style={{
                backgroundImage: 'url(/assets/images/faq-section-min.jpg)',
              }}
            ></div>
          </div>
        </div>
