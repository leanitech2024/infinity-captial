          ...
          <SwiperSlide className="slide-item-content">
            <div className="slide-item content_center">
              <div
                ...
                style={{
                  backgroundImage:
                    'url(/assets/images/sliders/slider-home-14-1.jpg)',
                }}
              ></div>
                    ...
                    <div className="slider_content">
                      ...
                      <ul className="animate_down">
                        ...
                        <li className="theme_btn_all ">
                          <Link
                            href="#"
                            className="theme-btn one color_white_1"
                          >
                            Our Service
                          </Link>
                        </li>
          ...
          <SwiperSlide className="slide-item-content">
            <div className="slide-item content_left">
              <div
                ...
                style={{
                  backgroundImage:
                    'url(/assets/images/sliders/slider-home-14-2.jpg)',
                }}
              ></div>
              <div className="medium-container">
                <div className="row align-items-center">
          ...
          <SwiperSlide className="slide-item-content">
            <div className="slide-item content_center">
              <div
                ...
                style={{
                  backgroundImage:
                    'url(/assets/images/sliders/slider-home-14-3.jpg)',
                }}
              ></div>
              <div className="medium-container">
                <div className="row align-items-center">
