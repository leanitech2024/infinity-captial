  ...
  return (
    <>
      <section className="slider style_three pag_position_two">
        <Swiper
          {...swiperOptions}
          className="banner_carousel  owl_nav_none owl_dots_block theme_carousel"
        >
          <SwiperSlide className="slide-item">
            <div className="slide-item-content content_center">
              <div
                ...
                style={{
                  backgroundImage: 'url(/assets/images/sliders/slider-4-3.jpg)',
                }}
              />
                    ...
                    >
                      ...
                      <ul>
                        <li>
                          <Link
                            href="#"
                            className="theme-btn five  animated _zoomIn"
                          >
                            Read More{' '}
                          </Link>
                        </li>
          ...
          <SwiperSlide className="slide-item">
            <div className="slide-item-content content_right">
              <div
                className="image-layer"
                style={{
                  backgroundImage: 'url(/assets/images/sliders/slider-4-2.jpg)',
                }}
              />
              <div className="auto-container">
                <div className="row">
          ...
          <SwiperSlide className="slide-item">
            <div className="slide-item-content content_left">
              <div
                className="image-layer"
                style={{
                  backgroundImage: 'url(/assets/images/sliders/slider-4-1.jpg)',
                }}
              />
              <div className="auto-container">
                <div className="row">
                  <div className="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    ...
                    >
                      ...
                      <p className="animated _flipInY">
                        ...
                        indignation <br /> and dislike men who are so beguiled.
                      </p>
                      <ul>
                        <li>
                          <Link
