  ...
  return (
    <>
      <section className="slider style_two  nav_position_one">
        <Swiper
          {...swiperOptions}
          className="banner_carousel  owl_nav_block owl_dots_none theme_carousel owl-themebanner_carousel  owl_nav_block owl_dots_none theme_carousel owl-theme"
        >
          <SwiperSlide className="slide-item">
            <div className="slide-item-content content_right">
              <div
                ...
                style={{
                  backgroundImage:
                    'url(/assets/images/sliders/slider-3-bg.jpg)',
                }}
              ></div>
              <div className="auto-container">
                <div className="row">
                    ...
                    <div className="slider_content">
                      ...
                      <ul>
                        <li>
                          <Link
                            href="#"
                            className="theme-btn three  animated _zoomIn"
                          >
                            Read More
                          </Link>
                        </li>
                  ...
                  <div className="col-md-12 col-lg-5 col-sm-12 col-xs-12 image_column">
                    <div
                      className="slider_image _flipInX"
              ...
              <div className="auto-container">
                <div className="row">
                  ...
                  <div className="col-md-12 col-lg-5 col-sm-12 col-xs-12 image_column">
                    ...
                    >
                      <img
                        src="/assets/images/sliders/slider-3-3.jpg"
                        className="img-fluid"
                        alt="slider image"
                      />
                    </div>
              ...
              <div className="auto-container">
                <div className="row">
                  ...
                  <div className="col-md-12 col-lg-5 col-sm-12 col-xs-12 image_column">
                    ...
                    >
                      <img
                        src="/assets/images/sliders/slider-3-1.jpg"
                        className="img-fluid"
                        alt="slider image"
                      />
                    </div>
