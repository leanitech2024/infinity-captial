...
export default function Team7() {
  return (
    <>
      <section className="team-section bg_light_1 position-relative">
        <div
          className="position_absolute curve_shape_top_1"
          data-negative="false"
        >
          <svg
        ...
        <div className="large-container">
            ...
            <div className="col-lg-7 m-auto">
              <div className="title_all_box style_seven text-center dark_color">
                <div className="title_sections">
                  ...
                  <div className="title">Meet our expert Team</div>
                  <div className="small_text_sub">Our Professionals</div>
                </div>
                {/*===============spacing==============*/}
          ...
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
              <div className="team_box style_five">
                <div className="team_box type_one">
                  <div className="content_box">
                    <h2>
                      <Link href="#">Amelia Margaret</Link>
                    </h2>
                    <h6>Director</h6>
                    <p>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
              <div className="team_box style_five">
                <div className="team_box type_one">
                  <div className="content_box">
                    <h2>
                      <Link href="#">Astely Fletcher</Link>
                    </h2>
                    <h6>Team Leader</h6>
                    <p>
                      The HR Manger of Creote, he is very intelligent and smart.
        ...
        {/*===============spacing==============*/}
        <div
          className="position_absolute curve_shape_bottom_1"
          data-negative="false"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
